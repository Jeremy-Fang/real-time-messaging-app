...
const RecentMessageCard = ({ imgURL, members, messages, idMap, onCustomClick }) => {
    ...
    return (
        <>
            <div className='recent-messages-container' onClick={onCustomClick}>
                <div className='entry'>
