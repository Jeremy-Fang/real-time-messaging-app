...
const MessageDashboard = ({ socket, setSocket, setLoggedIn, changePage }) => {
    ...
    const sendMessage = () => {
        if (selectedConvo != -1) {
            socket?.emit('send-message', sessionStorage.getItem('uid'), chatroomData[selectedConvo]._id, message)
    ...
    useEffect(() => {
        ...
        socket?.on('receive-message', (room, data) => {
            ...
            setselectedConvo(updatedData.findIndex(chatroom => chatroom._id == room))
                ...
                <div className='page-container'>
                    <div className='side-bar-container'>
                        ...
                        <div className='new-conversation-group'>
                            <button onClick={() => changePage('search-page')}>+</button>
                            New conversation
                        </div>
